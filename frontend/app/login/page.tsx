  ...
  return (
    <AuthShell>
      ...
      <form
        ...
        aria-describedby={status === "done" ? "login-status" : undefined}
      >
        <FormField
          ref={emailRef}
          id="email"
        ...
        {showForgotNote && (
          <InlineNotice>Password reset isn&rsquo;t available yet — it&rsquo;s coming in a later step.</InlineNotice>
        )}
        ...
        {status === "done" && (
          <div id="login-status">
            <InlineNotice>
              This screen is UI-only for now — real login connects in a later build step.
            </InlineNotice>
          </div>
        )}
      </form>
